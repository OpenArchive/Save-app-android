 ...
 */
class GDriveConduit(media: Media, context: Context) : Conduit(media, context), KoinComponent {
    ...
    private suspend fun uploadFile(
        ...
        try {
            ...
            drive.upload(fMeta, InputStreamContent(null, inputStream)) { bytesWritten, percent ->
