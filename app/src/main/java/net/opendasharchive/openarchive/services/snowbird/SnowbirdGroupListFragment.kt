        ...
        requireActivity().addMenuProvider(object : MenuProvider {
            ...
            override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
                return when (menuItem.itemId) {
                    R.id.action_add -> {
                        val action = SnowbirdGroupListFragmentDirections.actionFragmentSnowbirdGroupListToFragmentSnowbirdCreateGroup()
                ...
                viewModel.events.collect { event ->
                    when (event) {
                        is SnowbirdGroupEvent.NavigateToRepo -> {
                            val action = SnowbirdGroupListFragmentDirections.actionFragmentSnowbirdGroupListToFragmentSnowbirdListRepos(
