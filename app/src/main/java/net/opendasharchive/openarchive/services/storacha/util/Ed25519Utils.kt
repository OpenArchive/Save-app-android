...
object Ed25519Utils {
     ...
     */
    fun signChallenge(challenge: String, privateKey: Ed25519PrivateKeyParameters): String {
     ...
     */
    fun verifySignature(challenge: String, signature: String, publicKey: Ed25519PublicKeyParameters): Boolean {
        return try {
            val signer = Ed25519Signer()
    ...
    fun extractPublicKeyFromDid(did: String): Ed25519PublicKeyParameters? {
        return try {
            ...
            if (multicodecKey.size < 34 || 
                multicodecKey[0] != 0xed.toByte() || 
                multicodecKey[1] != 0x01.toByte()) {
                return null
            }
    ...
    private fun decodeBase58(input: String): ByteArray {
        ...
        val result = if (bytes.isNotEmpty() && bytes[0].toInt() == 0) {
